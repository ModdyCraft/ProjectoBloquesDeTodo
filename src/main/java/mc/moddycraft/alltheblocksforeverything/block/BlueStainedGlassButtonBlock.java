...
public class BlueStainedGlassButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_stained_glass_button")
	public static final Block block = null;

	public BlueStainedGlassButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 520);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_stained_glass_button");
		}
