...
public class BlueIceButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_ice_button")
	public static final Block block = null;

	public BlueIceButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 501);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_ice_button");
		}
