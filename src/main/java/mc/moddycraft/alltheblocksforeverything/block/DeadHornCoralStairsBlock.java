...
public class DeadHornCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_horn_coral_stairs")
	public static final Block block = null;

	public DeadHornCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_horn_coral_stairs");
		}
