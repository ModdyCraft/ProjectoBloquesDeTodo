...
public class CactusFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:cactus_fence_gate")
	public static final Block block = null;

	public CactusFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 384);
	}
