...
public class BlackTerracottaSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_terracotta_slab")
	public static final Block block = null;

	public BlackTerracottaSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 402);
	}
