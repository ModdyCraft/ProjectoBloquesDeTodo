...
public class BlackstoneFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blackstone_fence")
	public static final Block block = null;

	public BlackstoneFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 288);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstone_fence");
		}
