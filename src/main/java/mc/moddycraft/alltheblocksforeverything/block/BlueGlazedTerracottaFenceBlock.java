...
public class BlueGlazedTerracottaFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_glazed_terracotta_fence")
	public static final Block block = null;

	public BlueGlazedTerracottaFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 479);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_glazed_terracotta_fence");
		}
