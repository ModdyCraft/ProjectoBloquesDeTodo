...
public class BlueConcretePowderFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_powder_fence")
	public static final Block block = null;

	public BlueConcretePowderFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 460);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concrete_powder_fence");
		}
