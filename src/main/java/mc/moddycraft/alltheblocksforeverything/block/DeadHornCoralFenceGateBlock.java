...
public class DeadHornCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_horn_coral_fence_gate")
	public static final Block block = null;

	public DeadHornCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_horn_coral_fence_gate");
		}
