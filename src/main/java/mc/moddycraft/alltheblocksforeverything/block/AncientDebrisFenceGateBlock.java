...
public class AncientDebrisFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:ancient_debris_fence_gate")
	public static final Block block = null;

	public AncientDebrisFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_debris_fence_gate");
		}
