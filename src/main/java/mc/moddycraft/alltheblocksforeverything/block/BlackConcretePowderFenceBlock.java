...
public class BlackConcretePowderFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_concrete_powder_fence")
	public static final Block block = null;

	public BlackConcretePowderFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 326);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_concrete_powder_fence");
		}
