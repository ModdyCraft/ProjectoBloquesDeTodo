...
public class BrainCoralButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:brain_coral_button")
	public static final Block block = null;

	public BrainCoralButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("brain_coral_button");
		}
