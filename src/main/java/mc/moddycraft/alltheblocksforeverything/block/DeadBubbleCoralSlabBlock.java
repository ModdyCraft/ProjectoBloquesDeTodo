...
public class DeadBubbleCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_bubble_coral_slab")
	public static final Block block = null;

	public DeadBubbleCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_bubble_coral_slab");
		}
