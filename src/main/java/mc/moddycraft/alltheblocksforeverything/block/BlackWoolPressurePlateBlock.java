...
public class BlackWoolPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_wool_pressure_plate")
	public static final Block block = null;

	public BlackWoolPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 424);
	}
