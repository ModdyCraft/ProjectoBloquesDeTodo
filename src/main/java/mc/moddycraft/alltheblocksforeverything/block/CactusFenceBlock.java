...
public class CactusFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:cactus_fence")
	public static final Block block = null;

	public CactusFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 383);
	}
