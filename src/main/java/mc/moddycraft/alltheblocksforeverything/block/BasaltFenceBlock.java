...
public class BasaltFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:basalt_fence")
	public static final Block block = null;

	public BasaltFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 250);
	}
