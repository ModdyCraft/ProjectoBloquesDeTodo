...
public class BubbleCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bubble_coral_fence")
	public static final Block block = null;

	public BubbleCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("bubble_coral_fence");
		}
