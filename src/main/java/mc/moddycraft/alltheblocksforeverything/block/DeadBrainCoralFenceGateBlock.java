...
public class DeadBrainCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_brain_coral_fence_gate")
	public static final Block block = null;

	public DeadBrainCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_brain_coral_fence_gate");
		}
