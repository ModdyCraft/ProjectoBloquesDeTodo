...
public class BubbleCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bubble_coral_stairs")
	public static final Block block = null;

	public BubbleCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bubble_coral_stairs");
		}
