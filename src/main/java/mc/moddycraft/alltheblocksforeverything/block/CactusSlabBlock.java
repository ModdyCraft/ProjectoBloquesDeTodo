...
public class CactusSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:cactus_slab")
	public static final Block block = null;

	public CactusSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 382);
	}
