...
public class BlueStainedGlassStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_stained_glass_stairs")
	public static final Block block = null;

	public BlueStainedGlassStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 515);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_stained_glass_stairs");
		}
