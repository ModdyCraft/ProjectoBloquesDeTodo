...
public class BrainCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:brain_coral_fence")
	public static final Block block = null;

	public BrainCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 35);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("brain_coral_fence");
		}
