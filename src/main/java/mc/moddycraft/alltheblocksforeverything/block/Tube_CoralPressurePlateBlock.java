...
public class Tube_CoralPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:tube_coral_pressure_plate")
	public static final Block block = null;

	public Tube_CoralPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("tube_coral_pressure_plate");
		}
