...
public class AncientDebrisFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:ancient_debris_fence")
	public static final Block block = null;

	public AncientDebrisFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_debris_fence");
		}
