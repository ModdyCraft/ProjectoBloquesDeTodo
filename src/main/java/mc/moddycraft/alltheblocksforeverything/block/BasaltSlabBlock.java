...
public class BasaltSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:basalt_slab")
	public static final Block block = null;

	public BasaltSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 249);
	}
