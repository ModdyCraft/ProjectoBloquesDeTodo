...
public class Tube_CoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:tube_coral_slab")
	public static final Block block = null;

	public Tube_CoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("tube_coral_slab");
		}
