...
public class BasaltPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:basalt_pressure_plate")
	public static final Block block = null;

	public BasaltPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 252);
	}
