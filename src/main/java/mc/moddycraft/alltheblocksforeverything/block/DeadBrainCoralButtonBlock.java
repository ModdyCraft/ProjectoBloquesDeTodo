...
public class DeadBrainCoralButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_brain_coral_button")
	public static final Block block = null;

	public DeadBrainCoralButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_brain_coral_button");
		}
