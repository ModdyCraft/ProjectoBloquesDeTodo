...
public class BlueIceSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_ice_slab")
	public static final Block block = null;

	public BlueIceSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 497);
	}
