...
public class BlackWoolFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_wool_fence")
	public static final Block block = null;

	public BlackWoolFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 422);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_wool_fence");
		}
