...
public class BlackstoneFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blackstone_fence_gate")
	public static final Block block = null;

	public BlackstoneFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstone_fence_gate");
		}
