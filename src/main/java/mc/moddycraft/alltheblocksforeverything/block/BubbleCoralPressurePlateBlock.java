...
public class BubbleCoralPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bubble_coral_pressure_plate")
	public static final Block block = null;

	public BubbleCoralPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("bubble_coral_pressure_plate");
		}
