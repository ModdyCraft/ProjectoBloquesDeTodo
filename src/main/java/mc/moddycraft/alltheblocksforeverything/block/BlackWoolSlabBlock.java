...
public class BlackWoolSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_wool_slab")
	public static final Block block = null;

	public BlackWoolSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 421);
	}
