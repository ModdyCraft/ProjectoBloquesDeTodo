...
public class AncientDebrisButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:ancient_debris_button")
	public static final Block block = null;

	public AncientDebrisButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 215);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("ancient_debris_button");
		}
