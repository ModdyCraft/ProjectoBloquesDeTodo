...
public class BoneSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bone_slab")
	public static final Block block = null;

	public BoneSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 6);
	}
