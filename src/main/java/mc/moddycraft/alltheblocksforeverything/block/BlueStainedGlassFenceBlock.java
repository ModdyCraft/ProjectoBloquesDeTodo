...
public class BlueStainedGlassFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_stained_glass_fence")
	public static final Block block = null;

	public BlueStainedGlassFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 517);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_stained_glass_fence");
		}
