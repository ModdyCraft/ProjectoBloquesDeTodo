...
public class DirtFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dirt_fence")
	public static final Block block = null;

	public DirtFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 19);
	}
