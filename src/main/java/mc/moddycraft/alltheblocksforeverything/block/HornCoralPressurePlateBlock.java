...
public class HornCoralPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:horn_coral_pressure_plate")
	public static final Block block = null;

	public HornCoralPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("horn_coral_pressure_plate");
		}
