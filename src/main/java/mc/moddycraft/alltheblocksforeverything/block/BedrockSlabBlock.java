...
public class BedrockSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bedrock_slab")
	public static final Block block = null;

	public BedrockSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 268);
	}
