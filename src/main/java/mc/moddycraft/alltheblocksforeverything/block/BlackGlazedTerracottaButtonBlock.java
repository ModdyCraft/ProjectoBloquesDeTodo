...
public class BlackGlazedTerracottaButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_glazed_terracotta_button")
	public static final Block block = null;

	public BlackGlazedTerracottaButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 348);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("black_glazed_terracotta_button");
		}
