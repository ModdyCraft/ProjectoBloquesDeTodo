...
public class BlackConcreteFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_concrete_fence")
	public static final Block block = null;

	public BlackConcreteFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 307);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_concrete_fence");
		}
