...
public class BoneButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bone_button")
	public static final Block block = null;

	public BoneButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 53);
	}
