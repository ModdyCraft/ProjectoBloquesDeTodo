...
public class BedrockButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bedrock_button")
	public static final Block block = null;

	public BedrockButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 272);
	}
