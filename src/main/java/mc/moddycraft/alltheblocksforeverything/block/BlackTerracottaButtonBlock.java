...
public class BlackTerracottaButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_terracotta_button")
	public static final Block block = null;

	public BlackTerracottaButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 406);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("black_terracotta_button");
		}
