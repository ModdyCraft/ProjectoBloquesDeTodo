...
public class DiamondaButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:diamonda_button")
	public static final Block block = null;

	public DiamondaButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("diamonda_button");
		}
