...
public class BrainCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:brain_coral_slab")
	public static final Block block = null;

	public BrainCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("brain_coral_slab");
		}
