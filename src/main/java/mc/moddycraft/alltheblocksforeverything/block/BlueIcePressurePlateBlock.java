...
public class BlueIcePressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_ice_pressure_plate")
	public static final Block block = null;

	public BlueIcePressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 500);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_ice_pressure_plate");
		}
