...
public class EmeraldaFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:emeralda_fence")
	public static final Block block = null;

	public EmeraldaFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("emeralda_fence");
		}
