...
public class FireCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:fire_coral_slab")
	public static final Block block = null;

	public FireCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("fire_coral_slab");
		}
