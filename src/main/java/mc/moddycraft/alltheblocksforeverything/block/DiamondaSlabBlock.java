...
public class DiamondaSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:diamonda_slab")
	public static final Block block = null;

	public DiamondaSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 28);
	}
