...
public class BlueStainedGlassSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_stained_glass_slab")
	public static final Block block = null;

	public BlueStainedGlassSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_stained_glass_slab");
		}
