...
public class BlueConcretePowderButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_powder_button")
	public static final Block block = null;

	public BlueConcretePowderButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 463);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concrete_powder_button");
		}
