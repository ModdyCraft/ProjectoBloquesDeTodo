...
public class HornCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:horn_coral_fence_gate")
	public static final Block block = null;

	public HornCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("horn_coral_fence_gate");
		}
