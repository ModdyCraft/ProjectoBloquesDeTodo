...
public class BlueIceFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_ice_fence")
	public static final Block block = null;

	public BlueIceFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 498);
	}
