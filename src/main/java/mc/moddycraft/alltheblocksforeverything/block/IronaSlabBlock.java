...
public class IronaSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:irona_slab")
	public static final Block block = null;

	public IronaSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 192);
	}
