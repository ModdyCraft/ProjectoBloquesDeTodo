...
public class HornCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:horn_coral_slab")
	public static final Block block = null;

	public HornCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("horn_coral_slab");
		}
