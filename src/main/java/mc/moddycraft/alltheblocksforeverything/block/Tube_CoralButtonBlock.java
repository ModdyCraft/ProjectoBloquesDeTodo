...
public class Tube_CoralButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:tube_coral_button")
	public static final Block block = null;

	public Tube_CoralButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("tube_coral_button");
		}
