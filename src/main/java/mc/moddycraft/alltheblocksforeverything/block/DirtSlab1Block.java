...
public class DirtSlab1Block extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dirt_slab_1")
	public static final Block block = null;

	public DirtSlab1Block(AllTheBlocksForEverythingModElements instance) {
		super(instance, 4);
	}
