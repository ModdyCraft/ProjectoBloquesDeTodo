...
public class BubbleCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bubble_coral_fence_gate")
	public static final Block block = null;

	public BubbleCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("bubble_coral_fence_gate");
		}
