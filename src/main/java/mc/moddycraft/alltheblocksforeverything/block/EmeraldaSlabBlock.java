...
public class EmeraldaSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:emeralda_slab")
	public static final Block block = null;

	public EmeraldaSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 30);
	}
