...
public class EmeraldaButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:emeralda_button")
	public static final Block block = null;

	public EmeraldaButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("emeralda_button");
		}
