...
public class DeadBrainCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_brain_coral_stairs")
	public static final Block block = null;

	public DeadBrainCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_brain_coral_stairs");
		}
