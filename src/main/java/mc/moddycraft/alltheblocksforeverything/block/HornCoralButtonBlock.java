...
public class HornCoralButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:horn_coral_button")
	public static final Block block = null;

	public HornCoralButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("horn_coral_button");
		}
