...
public class BlackstoneSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blackstone_slab")
	public static final Block block = null;

	public BlackstoneSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 287);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blackstone_slab");
		}
