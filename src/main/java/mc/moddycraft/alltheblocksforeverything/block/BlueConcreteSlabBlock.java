...
public class BlueConcreteSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_slab")
	public static final Block block = null;

	public BlueConcreteSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 440);
	}
