...
public class IronaFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:irona_fence_gate")
	public static final Block block = null;

	public IronaFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("irona_fence_gate");
		}
