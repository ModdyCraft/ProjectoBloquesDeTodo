...
public class CactusStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:cactus_stairs")
	public static final Block block = null;

	public CactusStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 381);
	}
