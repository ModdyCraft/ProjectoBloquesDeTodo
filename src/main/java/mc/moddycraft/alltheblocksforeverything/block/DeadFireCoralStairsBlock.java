...
public class DeadFireCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_fire_coral_stairs")
	public static final Block block = null;

	public DeadFireCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 128);
	}
