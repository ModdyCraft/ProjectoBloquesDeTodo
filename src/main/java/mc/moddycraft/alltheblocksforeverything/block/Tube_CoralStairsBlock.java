...
public class Tube_CoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:tube_coral_stairs")
	public static final Block block = null;

	public Tube_CoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("tube_coral_stairs");
		}
