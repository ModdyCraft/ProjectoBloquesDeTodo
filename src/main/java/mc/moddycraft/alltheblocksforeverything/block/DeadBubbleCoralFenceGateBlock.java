...
public class DeadBubbleCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_bubble_coral_fence_gate")
	public static final Block block = null;

	public DeadBubbleCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_bubble_coral_fence_gate");
		}
