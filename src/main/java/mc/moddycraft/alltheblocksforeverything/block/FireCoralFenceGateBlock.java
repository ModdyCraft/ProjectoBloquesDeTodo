...
public class FireCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:fire_coral_fence_gate")
	public static final Block block = null;

	public FireCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("fire_coral_fence_gate");
		}
