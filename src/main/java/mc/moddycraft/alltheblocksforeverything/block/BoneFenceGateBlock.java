...
public class BoneFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bone_fence_gate")
	public static final Block block = null;

	public BoneFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("bone_fence_gate");
		}
