...
public class BlueGlazedTerracottaButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_glazed_terracotta_button")
	public static final Block block = null;

	public BlueGlazedTerracottaButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 482);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_glazed_terracotta_button");
		}
