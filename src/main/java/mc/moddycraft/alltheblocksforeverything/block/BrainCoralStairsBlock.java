...
public class BrainCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:brain_coral_stairs")
	public static final Block block = null;

	public BrainCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("brain_coral_stairs");
		}
