...
public class BedrockFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:bedrock_fence")
	public static final Block block = null;

	public BedrockFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 269);
	}
