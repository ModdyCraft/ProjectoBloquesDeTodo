...
public class BlackConcreteFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_concrete_fence_gate")
	public static final Block block = null;

	public BlackConcreteFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 308);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_concrete_fence_gate");
		}
