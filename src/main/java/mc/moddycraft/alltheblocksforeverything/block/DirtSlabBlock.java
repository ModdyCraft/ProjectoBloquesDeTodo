...
public class DirtSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dirt_slab")
	public static final Block block = null;

	public DirtSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 2);
	}
