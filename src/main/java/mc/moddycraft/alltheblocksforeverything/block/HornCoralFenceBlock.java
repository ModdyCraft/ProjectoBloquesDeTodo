...
public class HornCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:horn_coral_fence")
	public static final Block block = null;

	public HornCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("horn_coral_fence");
		}
