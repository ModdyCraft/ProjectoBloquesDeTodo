...
public class DeadBubbleCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_bubble_coral_stairs")
	public static final Block block = null;

	public DeadBubbleCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_bubble_coral_stairs");
		}
