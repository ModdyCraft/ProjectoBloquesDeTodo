...
public class DeadHornCoralPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_horn_coral_pressure_plate")
	public static final Block block = null;

	public DeadHornCoralPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_horn_coral_pressure_plate");
		}
