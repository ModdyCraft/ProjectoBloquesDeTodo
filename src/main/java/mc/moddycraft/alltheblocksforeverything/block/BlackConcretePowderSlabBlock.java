...
public class BlackConcretePowderSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_concrete_powder_slab")
	public static final Block block = null;

	public BlackConcretePowderSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_concrete_powder_slab");
		}
