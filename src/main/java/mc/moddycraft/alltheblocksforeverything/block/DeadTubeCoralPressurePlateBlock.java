...
public class DeadTubeCoralPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_tube_coral_pressure_plate")
	public static final Block block = null;

	public DeadTubeCoralPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_tube_coral_pressure_plate");
		}
