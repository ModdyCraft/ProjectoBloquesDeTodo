...
public class BlackGlazedTerracottaFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_glazed_terracotta_fence")
	public static final Block block = null;

	public BlackGlazedTerracottaFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 345);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_glazed_terracotta_fence");
		}
