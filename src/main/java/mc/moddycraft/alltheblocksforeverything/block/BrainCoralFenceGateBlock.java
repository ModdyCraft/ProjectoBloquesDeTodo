...
public class BrainCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:brain_coral_fence_gate")
	public static final Block block = null;

	public BrainCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("brain_coral_fence_gate");
		}
