...
public class DeadBrainCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_brain_coral_slab")
	public static final Block block = null;

	public DeadBrainCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_brain_coral_slab");
		}
