...
public class BlueConcreteFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_fence")
	public static final Block block = null;

	public BlueConcreteFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 441);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concrete_fence");
		}
