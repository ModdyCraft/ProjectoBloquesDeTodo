...
public class DeadTubeCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_tube_coral_fence")
	public static final Block block = null;

	public DeadTubeCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_tube_coral_fence");
		}
