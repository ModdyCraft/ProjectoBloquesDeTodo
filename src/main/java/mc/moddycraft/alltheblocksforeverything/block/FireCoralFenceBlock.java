...
public class FireCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:fire_coral_fence")
	public static final Block block = null;

	public FireCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("fire_coral_fence");
		}
