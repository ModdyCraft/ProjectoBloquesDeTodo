...
public class IronaFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:irona_fence")
	public static final Block block = null;

	public IronaFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 193);
	}
