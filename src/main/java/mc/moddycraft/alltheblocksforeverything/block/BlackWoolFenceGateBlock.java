...
public class BlackWoolFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_wool_fence_gate")
	public static final Block block = null;

	public BlackWoolFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 423);
	}
