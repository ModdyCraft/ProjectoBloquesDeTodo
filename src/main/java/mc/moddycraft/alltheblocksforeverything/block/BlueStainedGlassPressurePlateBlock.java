...
public class BlueStainedGlassPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_stained_glass_pressure_plate")
	public static final Block block = null;

	public BlueStainedGlassPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 519);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_stained_glass_pressure_plate");
		}
