...
public class FireCoralButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:fire_coral_button")
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("fire_coral_button");
		}
