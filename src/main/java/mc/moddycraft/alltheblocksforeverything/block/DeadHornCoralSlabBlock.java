...
public class DeadHornCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_horn_coral_slab")
	public static final Block block = null;

	public DeadHornCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_horn_coral_slab");
		}
