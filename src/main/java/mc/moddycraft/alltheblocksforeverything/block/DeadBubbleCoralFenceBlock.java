...
public class DeadBubbleCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_bubble_coral_fence")
	public static final Block block = null;

	public DeadBubbleCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_bubble_coral_fence");
		}
