...
public class BlueGlazedTerracottaSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_glazed_terracotta_slab")
	public static final Block block = null;

	public BlueGlazedTerracottaSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 478);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_glazed_terracotta_slab");
		}
