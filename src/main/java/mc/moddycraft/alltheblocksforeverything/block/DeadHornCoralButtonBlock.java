...
public class DeadHornCoralButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_horn_coral_button")
	public static final Block block = null;

	public DeadHornCoralButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_horn_coral_button");
		}
