...
public class EmeraldaPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:emeralda_pressure_plate")
	public static final Block block = null;

	public EmeraldaPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("emeralda_pressure_plate");
		}
