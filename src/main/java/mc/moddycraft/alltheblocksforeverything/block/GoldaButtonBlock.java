...
public class GoldaButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:golda_button")
	public static final Block block = null;

	public GoldaButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 91);
	}
