...
public class DeadHornCoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_horn_coral_fence")
	public static final Block block = null;

	public DeadHornCoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_horn_coral_fence");
		}
