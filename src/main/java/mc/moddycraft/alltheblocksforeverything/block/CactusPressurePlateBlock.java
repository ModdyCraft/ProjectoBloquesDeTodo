...
public class CactusPressurePlateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:cactus_pressure_plate")
	public static final Block block = null;

	public CactusPressurePlateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 385);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.MOBS,
					Block.Properties.create(Material.CACTUS).sound(SoundType.PLANT).hardnessAndResistance(0.4f, 2f).setLightLevel(s -> 0));
