...
public class BlueConcreteButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_button")
	public static final Block block = null;

	public BlueConcreteButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 444);
	}
	...
	public static class CustomBlock extends StoneButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concrete_button");
		}
