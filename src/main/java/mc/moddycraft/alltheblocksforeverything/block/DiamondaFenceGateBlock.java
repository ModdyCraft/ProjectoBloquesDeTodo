...
public class DiamondaFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:diamonda_fence_gate")
	public static final Block block = null;

	public DiamondaFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("diamonda_fence_gate");
		}
