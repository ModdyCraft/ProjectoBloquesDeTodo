...
public class Tube_CoralFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:tube_coral_fence")
	public static final Block block = null;

	public Tube_CoralFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("tube_coral_fence");
		}
