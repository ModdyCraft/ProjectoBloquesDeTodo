...
public class BlueIceFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_ice_fence_gate")
	public static final Block block = null;

	public BlueIceFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 499);
	}
