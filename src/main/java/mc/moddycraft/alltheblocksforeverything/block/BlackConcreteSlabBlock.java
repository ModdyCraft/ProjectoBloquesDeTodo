...
public class BlackConcreteSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_concrete_slab")
	public static final Block block = null;

	public BlackConcreteSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 306);
	}
