...
public class Tube_CoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:tube_coral_fence_gate")
	public static final Block block = null;

	public Tube_CoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("tube_coral_fence_gate");
		}
