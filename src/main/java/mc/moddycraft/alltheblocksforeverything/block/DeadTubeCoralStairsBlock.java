...
public class DeadTubeCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_tube_coral_stairs")
	public static final Block block = null;

	public DeadTubeCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_tube_coral_stairs");
		}
