...
public class DeadTubeCoralFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_tube_coral_fence_gate")
	public static final Block block = null;

	public DeadTubeCoralFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_tube_coral_fence_gate");
		}
