...
public class HornCoralStairsBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:horn_coral_stairs")
	public static final Block block = null;

	public HornCoralStairsBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("horn_coral_stairs");
		}
