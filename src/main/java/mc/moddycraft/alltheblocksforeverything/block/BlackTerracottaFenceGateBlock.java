...
public class BlackTerracottaFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_terracotta_fence_gate")
	public static final Block block = null;

	public BlackTerracottaFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_terracotta_fence_gate");
		}
