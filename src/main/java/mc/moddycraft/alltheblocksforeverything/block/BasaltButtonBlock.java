...
public class BasaltButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:basalt_button")
	public static final Block block = null;

	public BasaltButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 253);
	}
