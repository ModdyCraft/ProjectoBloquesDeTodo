...
public class BlueConcreteFenceGateBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_fence_gate")
	public static final Block block = null;

	public BlueConcreteFenceGateBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 442);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concrete_fence_gate");
		}
