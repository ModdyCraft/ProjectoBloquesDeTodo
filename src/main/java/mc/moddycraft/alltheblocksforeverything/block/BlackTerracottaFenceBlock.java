...
public class BlackTerracottaFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_terracotta_fence")
	public static final Block block = null;

	public BlackTerracottaFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 403);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_terracotta_fence");
		}
