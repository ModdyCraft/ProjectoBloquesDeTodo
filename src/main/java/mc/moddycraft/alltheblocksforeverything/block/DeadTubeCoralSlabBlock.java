...
public class DeadTubeCoralSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:dead_tube_coral_slab")
	public static final Block block = null;

	public DeadTubeCoralSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dead_tube_coral_slab");
		}
