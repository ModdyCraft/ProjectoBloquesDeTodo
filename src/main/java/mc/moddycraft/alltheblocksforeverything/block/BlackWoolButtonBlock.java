...
public class BlackWoolButtonBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:black_wool_button")
	public static final Block block = null;

	public BlackWoolButtonBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 425);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("black_wool_button");
		}
