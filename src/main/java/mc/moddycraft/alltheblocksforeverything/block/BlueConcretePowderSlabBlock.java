...
public class BlueConcretePowderSlabBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:blue_concrete_powder_slab")
	public static final Block block = null;

	public BlueConcretePowderSlabBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 459);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concrete_powder_slab");
		}
