...
public class DiamondaFenceBlock extends AllTheBlocksForEverythingModElements.ModElement {
	@ObjectHolder("all_the_blocks_for_everything:diamonda_fence")
	public static final Block block = null;

	public DiamondaFenceBlock(AllTheBlocksForEverythingModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("diamonda_fence");
		}
